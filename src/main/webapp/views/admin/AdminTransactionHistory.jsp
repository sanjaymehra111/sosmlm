...
$(function () {
  $(".TopPageNamePre").html('Transaction')
  $(".TopPageNamePost").html('History')
})
...
<h4> <i class="fa fa-pencil-square-o"></i> &nbsp; Transaction History</h4>
</div>
</div>
</div>
</div>
...
<div style="color:black">
    <br>
    <h2>Processing <i class="fa fa-spinner fa-pulse"></i></h2>
</div>
